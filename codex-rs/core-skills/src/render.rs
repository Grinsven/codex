...
const SKILL_METADATA_CONTEXT_WINDOW_PERCENT: usize = 5;
...
fn budget_warning_prefix(budget: SkillMetadataBudget, prefix: &str) -> String {
    match budget {
        SkillMetadataBudget::Tokens(_) => prefix.replacen(
            ...
            &format!("Exceeded skills context budget of {SKILL_METADATA_CONTEXT_WINDOW_PERCENT}%."),
            1,
        ),
...
mod tests {
    ...
    #[test]
    fn default_budget_uses_five_percent_of_full_context_window() {
        assert_eq!(
