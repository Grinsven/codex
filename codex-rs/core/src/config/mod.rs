...
pub struct Config {
    ...
    /// Whether to emit warnings when skill metadata is truncated to fit the context budget.
    pub show_skill_context_budget_warnings: bool,
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let include_skill_instructions = cfg
            ...
            .unwrap_or(true);
        let show_skill_context_budget_warnings = cfg
            .skills
            .as_ref()
            .and_then(|skills| skills.context_budget_warnings)
            .unwrap_or(true);
        ...
        let config = Self {
            ...
            show_skill_context_budget_warnings,
            include_environment_context,
